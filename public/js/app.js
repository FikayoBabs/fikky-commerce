...
var mapp = {};
mapp["firstName"] = firstName.trim()
mapp["lastName"] = lastName.trim()
mapp["password"] = password.trim()
mapp["email"] = emailAddress.trim()
mapp["phoneNo"] = phoneNo.trim()
mapp["gender"] = gender.trim()
socket.emit('register', {mapp});
